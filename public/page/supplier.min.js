...
$(function () {
    $tabelData.DataTable({
        processing: true,
        serverSide: true,
        ajax: { url: `${urlThis}/tabel`, type: 'POST' },
        autoWidth: false,
        responsive: true,
        search: { return: true },
        dom: 'Blfrtip',
        ...
        columnDefs: [
            ...
            { targets: [0, 9], className: 'dt-body-center' },
            { targets: 5, className: 'dt-body-right' },
            { targets: [7, 8], render: function (data, type, row) { return CirebonwebFormat.Tanggal(data) } },
        ...
        CirebonwebForm.FormFetch(`${urlThis}/getid`, { id }, 'POST', {})
            .done(function (response) {
                if (response.success) {
                    ...
                    $formData.find('#kontak').val(response.data.kontak);
